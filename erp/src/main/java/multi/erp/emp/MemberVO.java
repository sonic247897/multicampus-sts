...
public class MemberVO {
	...
	// 로그인 한 사용자의 정보가 여러 테이블에 있을 때
	private String deptname; // 로그인 사용자의 부서 정보
	private String menupath; // 로그인 사용자의 메뉴 페이지 정보(주소)
	private String job_category; // 로그인 사용자의 job분류 정보(~관리)
	//MultipartFile userImage;

	public MemberVO() {
		System.out.println("기본생성자");
	}
	// 로그인 파라미터 매핑용 생성자 (나중에 내가 쓸 일 있으면 쓰려고 만든것.. spring은 사용x)
